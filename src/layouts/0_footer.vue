<template>
  <div class="footerAndModals">
    ...
    <q-layout-footer class="bg6">
      <div class="footCont" v-scroll-reveal.reset="{ delay: 0, origin: 'left'}">
      ...
      <div class="copyRight" v-scroll-reveal.reset="{ delay: 0, origin: 'right'}">
        <span>Designed and built by</span> <a class="myMLink" href="https://www.mymacy.de">myMacy</a><span>2018 &copy;</span>
      </div>
      <div class="socialLinks">
        <a href="https://www.facebook.com/ma.cy.90">
          <q-icon class="fbLink" name="ion-logo-facebook" v-scroll-reveal.reset="{ delay: 100, origin: 'bottom'}" />
        </a>
        <a href="https://www.xing.com/profile/Marcel_Albrink/cv">
          <q-icon class="xiLink" name="ion-logo-xing" v-scroll-reveal.reset="{ delay: 200, origin: 'bottom'}" />
        </a>
        <a href="https://www.instagram.com/marcelalbrink/">
          <q-icon class="inLink" name="ion-logo-instagram" v-scroll-reveal.reset="{ delay: 300, origin: 'bottom'}" />
        </a>
      </div>
    </q-layout-footer>
